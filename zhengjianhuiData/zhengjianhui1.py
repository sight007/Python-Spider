...
def main():
    ...
    for i in range(0,25+1):
        print("第"+str(i)+"页")
        if i==0:
            url='http://www.csrc.gov.cn/pub/newsite/ssgsjgb/bgczwgg/index.htm'
        else:
            url='http://www.csrc.gov.cn/pub/newsite/ssgsjgb/bgczwgg/index_'+str(i)+'.htm'
